...
// import { paymentsApi, gymsApi, membersApi, membershipPlansApi } from "@/api/endpoints"
// import { useSubscription } from "@/hooks/useSubscription"
// import {
//   Header, Card, Badge, PlanGate, EmptyState,
//   SkeletonGroup, Input, Button,
// } from "@/components/common"
// import { Colors, Spacing, Typography, Radius } from "@/theme"
// import type {
//   Gym, OwnerPayment, PaymentsListResponse,
//   GymMemberListItem, MembersListResponse, MembershipPlan,
// } from "@/types/api"
...
//     gymId: "", memberId: "", membershipPlanId: "",
...
//   const { data, isLoading, refetch, isRefetching } = useQuery<PaymentsListResponse>({
//     queryKey: ["ownerPayments", gymId],
//     queryFn:  () => paymentsApi.list({ gymId: gymId || undefined }) as Promise<PaymentsListResponse>,
//     enabled:  hasPayments,
//     staleTime: 60_000,
//   })
...
//   useEffect(() => {
//     if (form.gymId) {
//       membersApi.list({ gymId: form.gymId })
//         .then((d: unknown) => setMembers((d as MembersListResponse).members ?? []))
//         .catch(() => {})
//       membershipPlansApi.list(form.gymId)
...
//       setShowAdd(false)
//       setForm(f => ({ ...f, memberId: "", membershipPlanId: "", amount: "", notes: "" }))
...
//               >
//                 <Text style={[ps.pillT, gymId === g.id && ps.pillTA]}>{g.name}</Text>
//               </TouchableOpacity>
//             ))}
//           </View>
//         )}
...
//             action={
//               <TouchableOpacity style={ps.emptyAction} onPress={() => setShowAdd(true)}>
...
//                   <View style={{ flex: 1 }}>
//                     <Text style={ps.payName}>{p.member?.profile?.fullName}</Text>
//                     <Text style={ps.paySub}>{p.gym?.name} · {p.planNameSnapshot ?? "Payment"}</Text>
...
//                   >
//                     <Text style={[ps.chipT, form.gymId === g.id && ps.chipTA]}>{g.name}</Text>
//                   </TouchableOpacity>
//                 ))}
//               </View>
//             </View>
...
//                   >
//                     <Text style={[ps.chipT, form.memberId === m.id && ps.chipTA]} numberOfLines={1}>
//                       {m.profile?.fullName}
//                     </Text>
//                   </TouchableOpacity>
//                 ))}
...
//               <View style={ps.chips}>
//                 {[{ id: "", name: "None" } as MembershipPlan, ...plans].map(p => (
//                   <TouchableOpacity
//                     key={p.id}
//                     onPress={() => set("membershipPlanId", p.id)}
//                     style={[ps.chip, form.membershipPlanId === p.id && ps.chipA]}
//                   >
//                     <Text style={[ps.chipT, form.membershipPlanId === p.id && ps.chipTA]}>
//                       {p.name}
//                     </Text>
//                   </TouchableOpacity>
//                 ))}
...
//                   >
//                     <Text style={[ps.chipT, form.paymentMethod === m && ps.chipTA]}>
//                       {m.replace("_", " ")}
//                     </Text>
//                   </TouchableOpacity>
//                 ))}
...
//                   Toast.show({ type: "error", text1: "Gym, member and amount are required" })
//                   return
//                 }
//                 addMutation.mutate()
//               }}
...
//   payName:    { color: Colors.textPrimary, fontSize: Typography.sm, fontWeight: "600" },
...
//   payAmount:  { color: Colors.primary, fontSize: Typography.lg, fontWeight: "700" },
//   modalHeader:{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: Spacing.sm },
//   modalTitle: { color: Colors.textPrimary, fontSize: Typography.xl, fontWeight: "700" },
//   fieldLabel: { color: Colors.textMuted, fontSize: Typography.xs, fontWeight: "500", marginBottom: 8, letterSpacing: 0.3 },
