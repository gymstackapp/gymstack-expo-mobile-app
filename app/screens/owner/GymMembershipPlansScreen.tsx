    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: Colors.bg }}>
      ...
      {isLoading ? (
        <View style={{ padding: Spacing.lg }}>
          <SkeletonGroup count={3} itemHeight={100} gap={Spacing.md} />
        </View>
      ) : plans.length === 0 ? (
        <EmptyState
          icon="tag-outline"
          title="No plans yet"
          subtitle="Create your first membership plan"
          action={
            canAddMembershipPlan ? (
              <TouchableOpacity
                style={{
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: Colors.bg }}>
          ...
          >
            ...
            <Input
              ...
              placeholder="Cardio, Weight training, Diet plan"
              multiline
              numberOfLines={2}
            />
            <Button
