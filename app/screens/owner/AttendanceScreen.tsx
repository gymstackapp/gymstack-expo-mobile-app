...
// import { ownerAttendanceApi, gymsApi } from "@/api/endpoints"
// import { useSubscription } from "@/hooks/useSubscription"
// import { Header, Avatar, PlanGate, EmptyState, SkeletonGroup } from "@/components/common"
// import { Colors, Spacing, Typography, Radius } from "@/theme"
// import type { OwnerAttendanceRecord, Gym } from "@/types/api"
...
//   // const { data = [], isLoading, refetch, isRefetching } = useQuery<OwnerAttendanceRecord[]>({
//   //   queryKey: ["ownerAttendance", gymId, search],
//   //   queryFn:  async () => {
//   //     const res = await ownerAttendanceApi.list({
//   //       gymId:  gymId  || undefined,
//   //       search: search || undefined,
//   //     }) as OwnerAttendanceRecord[]
...
//               >
//                 <Text style={[st.pillT, gymId === g.id && st.pillTA]}>{g.name}</Text>
//               </TouchableOpacity>
//             ))}
//           </View>
//         )}
...
//                       {isToday
//                         ? "Today"
//                         : cin.toLocaleDateString("en-IN", { weekday: "short", day: "numeric", month: "short" })}
...
//   activeDot:  { backgroundColor: Colors.successFaded, borderRadius: Radius.full, paddingHorizontal: 6, paddingVertical: 2 },
