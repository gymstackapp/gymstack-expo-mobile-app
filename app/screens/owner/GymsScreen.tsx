// // mobile/src/screens/owner/GymsScreen.tsx
...
// import { Header, EmptyState, SkeletonGroup } from "@/components/common"
// import { Colors, Spacing, Typography, Radius } from "@/theme"
// import type { Gym } from "@/types/api"

// function GymCard({ gym, onPress }: { gym: Gym; onPress: () => void }) {
//   return (
//     <TouchableOpacity onPress={onPress} activeOpacity={0.7} style={styles.gymCard}>
...
//         <View style={[
//           styles.activePill,
//           { backgroundColor: gym.isActive ? Colors.success + "cc" : Colors.textMuted + "80" },
//         ]}>
//           <Text style={styles.activePillText}>{gym.isActive ? "Active" : "Inactive"}</Text>
//         </View>
//         {gym.gymImages?.length > 1 && (
//           <View style={styles.photoCount}>
//             <Icon name="image-multiple-outline" size={11} color="#fff" />
//             <Text style={styles.photoCountText}>{gym.gymImages.length}</Text>
//           </View>
//         )}
//       </View>
...
//             <Text style={styles.locationText}>{gym.city}</Text>
//           </View>
//         ) : null}
...
//           </View>
//           <View style={styles.stat}>
//             <Icon name="account-tie-outline" size={13} color={Colors.textSecondary} />
...
//                 <Text style={styles.planChipText} numberOfLines={1}>{p.name}</Text>
//               </View>
//             ))}
//             {gym.membershipPlans.length > 2 && (
//               <View style={styles.planChip}>
//                 <Text style={styles.planChipText}>+{gym.membershipPlans.length - 2}</Text>
//               </View>
//             )}
//           </View>
//         ) : null}
...
// export function OwnerGymsScreen() {
//   const navigation = useNavigation()
//   const { canAddGym, usage, limits } = useSubscription()

//   const { data: gyms = [], isLoading, refetch, isRefetching } = useQuery<Gym[]>({
//     queryKey: ["ownerGyms"],
...
//                 <Text style={styles.limitText}>{usage?.gyms}/{limits?.maxGyms}</Text>
//               </TouchableOpacity>
//             ) : (
//               <TouchableOpacity
//                 style={styles.addBtn}
...
//           <SkeletonGroup variant="card" count={3} itemHeight={200} gap={Spacing.md} />
//         </View>
//       ) : gyms.length === 0 ? (
//         <EmptyState
//           icon="dumbbell"
...
//             <GymCard
//               gym={item}
//               onPress={() => (navigation as any).navigate("OwnerGymDetail", { gymId: item.id })}
//             />
//           )}
...
//   gymCard:     { backgroundColor: Colors.surface, borderRadius: Radius.xl, borderWidth: 1, borderColor: Colors.border, overflow: "hidden" },
//   gymCover:    { height: 130, backgroundColor: Colors.surfaceRaised, position: "relative" },
//   coverImagePlaceholder: { flex: 1, backgroundColor: Colors.surfaceRaised },
//   coverPlaceholder: { flex: 1, alignItems: "center", justifyContent: "center" },
//   activePill:  { position: "absolute", top: 10, left: 10, paddingHorizontal: 8, paddingVertical: 3, borderRadius: Radius.full },
//   activePillText: { color: "#fff", fontSize: 10, fontWeight: "700" },
//   photoCount:  { position: "absolute", top: 10, right: 10, flexDirection: "row", alignItems: "center", gap: 3, backgroundColor: "rgba(0,0,0,0.55)", borderRadius: Radius.full, paddingHorizontal: 7, paddingVertical: 3 },
//   photoCountText: { color: "#fff", fontSize: 10 },
//   gymBody:     { padding: Spacing.lg, gap: Spacing.sm },
//   gymName:     { color: Colors.textPrimary, fontSize: Typography.lg, fontWeight: "700" },
...
//   planChip:    { backgroundColor: Colors.surfaceRaised, borderRadius: Radius.full, paddingHorizontal: 8, paddingVertical: 3, borderWidth: 1, borderColor: Colors.border },
